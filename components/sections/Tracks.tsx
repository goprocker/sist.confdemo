            ...
            <section id="tracks" className="py-24">
                <div className="container mx-auto px-6">
                        ...
                        {tracksData.map((track, index) => {
                            ...
                            return (
                                <motion.div
                                    ...
                                    className="bg-gray-900 p-8 rounded-2xl shadow-lg hover:shadow-2xl hover:shadow-blue-900/20 transition-all border border-white/10 group"
                                >
                                    <div className="w-14 h-14 bg-blue-900/30 rounded-xl flex items-center justify-center text-blue-400 mb-6 group-hover:bg-blue-600 group-hover:text-white transition-colors">
                    ...
                    <div className="mt-16 text-center">
                        <button className="px-8 py-3 bg-transparent border border-blue-500 text-blue-400 rounded-full font-semibold hover:bg-blue-600 hover:text-white transition-all hover:shadow-[0_0_20px_rgba(37,99,235,0.5)]">
