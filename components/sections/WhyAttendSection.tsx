...
function SpotlightCard({ reason, index }: { reason: typeof reasons[0], index: number }) {
    ...
    return (
        <FadeIn delay={index * 0.1} className="h-full">
            <div
                className="group relative border border-white/10 bg-gray-900 px-8 py-10 rounded-2xl h-full overflow-hidden"
            ...
            `,
                ...
                <div className="relative">
                    <div className="w-14 h-14 bg-blue-500/10 rounded-xl flex items-center justify-center text-blue-400 mb-6 group-hover:bg-blue-500 group-hover:text-white transition-colors">
                        <reason.icon size={28} />
                    </div>
            ...
            <div className="container mx-auto px-6">
                <FadeIn>
                    <div className="text-center mb-20">
                        <h2 className="text-4xl font-bold text-white mb-6">Why Attend Conf2025?</h2>
