...
export default function Hero() {
    return (
        <section id="hero" className="relative min-h-screen flex flex-col justify-center items-center overflow-hidden bg-gray-950 text-white pt-32">
            {/* Dynamic Background */}
            <div className="absolute inset-0 z-0">
                ...
                <div className="absolute inset-0 z-0">
                    <Image
                        ...
                        priority
                    />
                    <div className="absolute inset-0 bg-gradient-to-b from-gray-950/30 via-gray-950/60 to-gray-950"></div>
                </div>
                ...
                <div className="absolute top-0 left-0 w-full h-full overflow-hidden opacity-30 z-10">
                    <motion.div
                        ...
                        className="absolute top-[-10%] left-[-10%] w-[50vw] h-[50vw] bg-blue-600 rounded-full mix-blend-screen filter blur-[120px]"
                    />
                    <motion.div
                        animate={{
                            scale: [1, 1.1, 1],
                        ...
                        className="absolute bottom-[-10%] right-[-10%] w-[50vw] h-[50vw] bg-purple-600 rounded-full mix-blend-screen filter blur-[120px]"
                    />
                </div>
                <div className="absolute inset-0 bg-[url('/grid-pattern.svg')] opacity-[0.03] z-10"></div>
            </div>

            <div className="container mx-auto px-6 relative z-10 text-center">
                <FadeIn direction="down" delay={0.2}>
                    <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/5 backdrop-blur-md border border-white/10 text-sm font-medium mb-8 text-blue-300">
                ...
                <FadeIn delay={1.1}>
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
                        <Link href="/registration" className="group relative px-8 py-4 bg-blue-600 hover:bg-blue-500 text-white rounded-full font-bold text-lg transition-all transform hover:scale-105 hover:shadow-[0_0_40px_-10px_rgba(37,99,235,0.5)] flex items-center gap-2">
