...
export default function AboutConference() {
    return (
        <div className="bg-gray-950 min-h-screen pt-32">
                    ...
                    <div className="flex flex-col md:flex-row items-center gap-16">
                        <ScaleIn className="md:w-1/2">
                            <div className="relative">
                                ...
                                <div className="relative h-[400px] w-full rounded-2xl overflow-hidden bg-gray-900 border border-white/10">
                        ...
                        >
                            <h2 className="text-4xl font-bold mb-6 text-white">About the Conference</h2>
            ...
            <section id="committee" className="py-24 bg-gray-900">
                <div className="container mx-auto px-6">
                    <FadeIn>
                        <h2 className="text-3xl font-bold text-white mb-12 text-center">Organizing Committee</h2>
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                            {[1, 2, 3].map((i) => (
                                <div key={i} className="bg-gray-950 border border-white/10 p-8 rounded-2xl text-center hover:border-blue-500/50 transition-colors">
                                    <div className="w-24 h-24 bg-gray-800 rounded-full mx-auto mb-6 flex items-center justify-center text-gray-500">
                                        Photo
                                    </div>
                                    <h3 className="text-xl font-bold text-white mb-2">Committee Member {i}</h3>
            ...
            <section id="partners" className="py-24">
                <div className="container mx-auto px-6">
                    <FadeIn>
                        <h2 className="text-3xl font-bold text-white mb-12 text-center">Partner Institutions</h2>
                        <div className="flex flex-wrap justify-center gap-12 opacity-70">
                            {[1, 2, 3, 4].map((i) => (
                                <div key={i} className="w-40 h-20 bg-white/5 rounded-lg flex items-center justify-center text-gray-500 font-bold border border-white/10">
                                    Partner {i}
                                </div>
                            ))}
                        </div>
