                    ...
                    <div className="flex flex-col md:flex-row gap-12 items-center">
                        <div className="md:w-1/2">
                            <FadeIn direction="right">
                                <h2 className="text-4xl font-bold text-secondary-900 mb-6">The Venue</h2>
                                ...
                                <div className="space-y-6">
                                    <div className="flex items-start gap-4 p-4 rounded-xl bg-secondary-900 border border-secondary-800 shadow-lg">
                                        <div className="font-bold text-secondary-400 w-24">Address:</div>
                                        <div className="text-gray-100">Jeppiaar Nagar, Rajiv Gandhi Salai, Chennai - 600 119</div>
                                    </div>

                                    <div id="hotels" className="scroll-mt-32"></div>
                                    <div className="flex items-start gap-4 p-4 rounded-xl bg-secondary-900 border border-secondary-800 shadow-lg">
                                        <div className="font-bold text-secondary-400 w-24">Hotels:</div>
                                    ...
                                    <div className="flex items-start gap-4 p-4 rounded-xl bg-secondary-900 border border-secondary-800 shadow-lg">
                                        <div className="font-bold text-secondary-400 w-24">Travel:</div>
                                        <div className="text-gray-100">
                                            <p className="mb-2">Easy access via OMR IT Expressway.</p>
                                            <p className="text-sm text-gray-200">Chennai Airport: 45 mins by car</p>
                                        </div>
                                    </div>
                                </div>
                            </FadeIn>
                        ...
                        <div className="md:w-1/2 w-full">
                            <FadeIn direction="left" delay={0.2}>
                                <div className="h-[400px] bg-secondary-900 rounded-2xl overflow-hidden relative shadow-2xl border border-secondary-800">
                                    <iframe
